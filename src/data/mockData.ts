...
export const accommodations: Accommodation[] = [
  {
    ...
    type: 'private',
    rating: 4.5,
    location: 'حي الجامعة، كفر الشيخ',
    bedrooms: 2,
    bathrooms: 1,
    amenities: ['واي فاي', 'مكيف', 'غسالة', 'مطبخ مجهز', 'أمن 24 ساعة'],
    description: 'شقة واسعة ومجهزة بالكامل تقع بالقرب من جامعة كفر الشيخ. تتميز الشقة بتصميم عصري وإطلالة رائعة، وهي مثالية للطلاب الذين يبحثون عن الراحة والخصوصية.',
    hostName: 'محمود خليل',
  ...
  },
  {
    ...
    type: 'private',
    rating: 4.8,
    location: 'شارع صلاح سالم، كفر الشيخ',
    bedrooms: 1,
    bathrooms: 1,
    amenities: ['واي فاي', 'مكيف', 'غسالة', 'مطبخ مجهز', 'تراس', 'مصعد'],
    description: 'استوديو أنيق بتصميم مودرن في أرقى أحياء كفر الشيخ. مجهز بذكاء لاستغلال المساحات، ويحتوي على كل المرافق التي قد يحتاجها الطالب لحياة مريحة ومستقلة.',
    hostName: 'هالة منصور',
  ...
  },
  {
    ...
    type: 'shared',
    rating: 4.0,
    location: 'حي المساكن، كفر الشيخ',
    bedrooms: 3,
    bathrooms: 2,
    amenities: ['واي فاي', 'مكيف', 'مطبخ مشترك', 'غرفة معيشة', 'شرفة'],
    description: 'شقة فسيحة تضم عدة غرف للطلاب. تقع بمنطقة حيوية قريبة من الأسواق والمطاعم. مساحات مشتركة واسعة تسمح بالتواصل والراحة.',
    hostName: 'ياسين علي',
  ...
  },
  {
    ...
    type: 'private',
    rating: 4.9,
    location: 'حي النور، كفر الشيخ',
    bedrooms: 3,
    bathrooms: 2,
    amenities: ['واي فاي', 'مكيف', 'غسالة', 'مطبخ مجهز', 'حمام سباحة', 'جيم', 'حديقة'],
    description: 'تجربة سكنية استثنائية في أرقى أحياء كفر الشيخ. إطلالة بانورامية ومرافق ترفيهية متكاملة لضمان أعلى مستويات الرفاهية والتركيز.',
    hostName: 'سارة فريد',
    hostAvatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop'
  },
  {
    id: '6',
    title: 'غرفة مريحة قرب المواصلات',
    ...
    type: 'shared',
    rating: 4.3,
    location: 'شارع بورسعيد، كفر الشيخ',
    bedrooms: 1,
    bathrooms: 1,
    amenities: ['واي فاي', 'مكيف', 'قريب من المواصلات'],
    description: 'غرفة مؤثثة بعناية في موقع استراتيجي جداً بالقرب من المواصلات العامة، مما يسهل التنقل إلى الجامعة وأي مكان في كفر الشيخ.',
...
export const services: Service[] = [
  ...
  },
  {
    ...
    distance: 0.5,
    rating: 4.8,
    address: 'شارع صلاح سالم، كفر الشيخ',
    phone: '+20 47 322 4321',
    hours: '24 ساعة',
    lat: 31.1120,
    lng: 30.9370
  },
  ...
  },
  {
    ...
    distance: 0.2,
    rating: 4.3,
    address: 'الموقف الجديد، كفر الشيخ',
    phone: '+20 47 325 0000',
    hours: '5:00 ص - 1:00 م',
  },
  {
    id: '6',
...
export const helpRequests: HelpRequest[] = [
  {
    ...
    description: 'أبحث عن شقة مشتركة قريبة من جامعة كفر الشيخ، ميزانيتي 2000 جنيه شهرياً',
    category: 'housing',
  ...
  },
  {
    ...
    description: 'فقدت جواز سفري في منطقة الجامعة بكفر الشيخ، أرجو المساعدة',
    category: 'emergency',
